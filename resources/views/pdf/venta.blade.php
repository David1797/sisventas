...
<html>
    ...
    <body>
        ...
        <header>
            <div id="logo">
                <img src="img/cn.png" alt="Comisariato Naturista" id="imagen">
            </div>
            <div id="datos">
                <p id="encabezado">
                    <b>Comisariato Naturista</b><br>Guayaquil, Ecuador<br>Telefono:(+593)999999999<br>Email: comisariatonaturista@hotmail.com
                </p>
            </div>
            <div id="fact">
